...
const planetaryData = [
  {
    year: 2025,
    planets: [
      { name: "Uranus", date: "Jan 01", equipment: "CDK 20", description: "Placeholder Entry", image: placeholderImg },
    ]
  }
];
    ...
    <div className="min-h-screen bg-background text-foreground pt-20">
      ...
      <div className="container mx-auto px-6 py-12">
        <div className="flex items-center gap-4 mb-8 text-sm text-muted-foreground uppercase tracking-widest">
          ...
          <span className="text-primary">Uranus Archive</span>
        </div>

        <div className="max-w-3xl mb-16">
          <h1 className="text-5xl md:text-7xl font-serif mb-6 uppercase tracking-wide">Uranus</h1>
          <p className="text-xl text-muted-foreground font-light">The seventh planet from the Sun. It has the third-largest planetary radius and fourth-largest planetary mass in the Solar System. Known for its distinct cyan color.</p>
        </div>
