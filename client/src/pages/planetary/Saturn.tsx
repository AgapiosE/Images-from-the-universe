...
import saturnTethys from "@assets/stock_images/saturn_with_tethys_t_a3b5d318.jpg";

const planetaryData = [
  {
    year: 2025,
    planets: [
      { name: "Saturn", date: "Nov 22", equipment: "CDK 20", description: "Titan Transit", image: saturnTitan },
      { name: "Saturn", date: "Nov 22", equipment: "CDK 20", description: "Tethys nearby", image: saturnTethys },
    ]
  },
  {
    year: 2022,
    planets: [
      { name: "Saturn", date: "Aug 14", equipment: "11-inch SCT", description: "Opposition - Seeliger Effect", image: saturnTitan },
    ]
  },
  {
    year: 2020,
    planets: [
      { name: "Saturn", date: "Jul 20", equipment: "C11 EdgeHD", description: "Hexagon clearly visible", image: saturnTitan },
    ]
  },
  {
    year: 2017,
    planets: [
      { name: "Saturn", date: "Jun 15", equipment: "C9.25", description: "Wide ring tilt", image: saturnTitan },
    ]
  }
];
    ...
    <div className="min-h-screen bg-background text-foreground pt-20">
      ...
      <div className="container mx-auto px-6 py-12">
        <div className="flex items-center gap-4 mb-8 text-sm text-muted-foreground uppercase tracking-widest">
          ...
          <span className="text-primary">Saturn Archive</span>
        </div>

        <div className="max-w-3xl mb-16">
          <h1 className="text-5xl md:text-7xl font-serif mb-6 uppercase tracking-wide">Saturn</h1>
          <p className="text-xl text-muted-foreground font-light">
            Observing the Ringed Planet. Documenting ring plane changes and atmospheric storms.
          </p>
        </div>
