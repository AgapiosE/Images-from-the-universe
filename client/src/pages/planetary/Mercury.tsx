...
const planetaryData = [
  {
    year: 2025,
    planets: [
      { name: "Mercury", date: "Jan 01", equipment: "CDK 20", description: "Placeholder Entry", image: placeholderImg },
    ]
  }
];
    ...
    <div className="min-h-screen bg-background text-foreground pt-20">
      ...
      <div className="container mx-auto px-6 py-12">
        <div className="flex items-center gap-4 mb-8 text-sm text-muted-foreground uppercase tracking-widest">
          ...
          <span className="text-primary">Mercury Archive</span>
        </div>

        <div className="max-w-3xl mb-16">
          <h1 className="text-5xl md:text-7xl font-serif mb-6 uppercase tracking-wide">Mercury</h1>
          <p className="text-xl text-muted-foreground font-light">The smallest planet in the Solar System and closest to the Sun. Difficult to image due to its proximity to the Sun, often requiring imaging during twilight or daylight hours.</p>
        </div>
